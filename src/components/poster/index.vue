<template>
    <div>
        <div class="head-back">
            ...
            <h2 class="headerTitle" title="我的海报" v-text="$t('LeftNav.MyTicket')"></h2>
...
import { api_url, initAllWeiXin } from '../../common/js/common.js'
...
export default {
    ...
    computed: {
        createPersonImage: function(){
            return `${api_url}/tinyPoster/createPersonImage?projectId=${this.projectId}`;
        }
    },
    methods: {
        routerBack: function(){
